...
import losfreitasapps.com.incidenciasradiologicas.Incidencias.Cranio;
...
public class ShowCranioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voltar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                if(idList>0) {
                    idList = idList - 1;
                    incidencia = Cranio.getIcranio().get(idList);
                    ...
                    esquerda.setImageResource(R.drawable.nulo);
                    direita.setImageResource(R.drawable.ic_direita);
                    Toast.makeText(ShowCranioActivity.this, (idList+1)+" de " + (szList)+"\n"+incidencia.getTitulo(), Toast.LENGTH_SHORT).show();
                } else{
                    Toast.makeText(ShowCranioActivity.this, 1 +" de " + (szList)+"\n"+incidencia.getTitulo(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        avancar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                if(idList<(szList-1)) {
                    ...
                    Toast.makeText(ShowCranioActivity.this, (szList) +" de " + (szList)+"\n"+incidencia.getTitulo(), Toast.LENGTH_SHORT).show();
                }
            }
        });
