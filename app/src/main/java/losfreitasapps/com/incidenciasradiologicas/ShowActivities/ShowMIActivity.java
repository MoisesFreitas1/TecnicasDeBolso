...
import losfreitasapps.com.incidenciasradiologicas.Incidencias.MI;
...
public class ShowMIActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setText("  Membros Inferiores");
        ...
        voltar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                if(idList>0) {
                    idList = idList - 1;
                    incidencia = MI.getImi().get(idList);
                    ...
                    esquerda.setImageResource(R.drawable.nulo);
                    direita.setImageResource(R.drawable.ic_direita);
                    Toast.makeText(ShowMIActivity.this, (idList+1)+" de " + (szList)+"\n"+incidencia.getTitulo(), Toast.LENGTH_SHORT).show();
                } else{
                    Toast.makeText(ShowMIActivity.this, 1 +" de " + (szList)+"\n"+incidencia.getTitulo(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        avancar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                if(idList<(szList-1)) {
                    ...
                    Toast.makeText(ShowMIActivity.this, (szList) +" de " + (szList)+"\n"+incidencia.getTitulo(), Toast.LENGTH_SHORT).show();
                }
            }
        });
