...
public class ShowMSActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setText("  Membros Superiores");
        ...
        voltar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                if(idList>0) {
                    idList = idList - 1;
                    incidencia = MS.getIms().get(idList);
                    ...
                    esquerda.setImageResource(R.drawable.nulo);
                    direita.setImageResource(R.drawable.ic_direita);
                    Toast.makeText(ShowMSActivity.this, (idList+1)+" de " + (szList)+"\n"+incidencia.getTitulo(), Toast.LENGTH_SHORT).show();
                } else{
                    Toast.makeText(ShowMSActivity.this, 1 +" de " + (szList)+"\n"+incidencia.getTitulo(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        avancar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                if(idList<(szList-1)) {
                    ...
                    Toast.makeText(ShowMSActivity.this, (szList) +" de " + (szList)+"\n"+incidencia.getTitulo(), Toast.LENGTH_SHORT).show();
                }
            }
        });
